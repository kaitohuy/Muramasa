...
public class NPC_Merchant extends Entity{
	...
	public void setDialogue() {
		...
		dialogues[0][0] = "Sứ mệnh gia tộc ta là tạo ra những vũ khí, vật phẩm\nđể tiêu diệt quỷ dữ. Tất nhiên cái gì cũng có giá của\nchúng. Lần này ngươi tới để mua hay bán đây ?";

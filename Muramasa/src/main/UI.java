...
public class UI {
	...
	public void drawPlayerLife() {
	 ...
	 // Vẽ nền màu xám trước cho thanh máu
	    g2.setColor(new Color(50, 50, 50)); // Màu xám
	    g2.fillRect(x + 64, y + 36, manaBarWidth - 24, barHeight); // Vẽ thanh xám
	    
	    // Vẽ thanh năng lượng (mana)
	    g2.setColor(new Color(0, 0, 255)); // Màu xanh cho thanh mana
	    g2.fillRect(x + 64, y + 36, manaBarWidth - 24, barHeight); // Vẽ thanh mana
	...
	public void drawDialogueScreen() {
		...
		if(npc.dialogues[npc.dialogueSet][npc.dialogueIndex] != null) {
			...
			if(gp.keyH.enterPressed == true && endLine == false) {
			...
			if(endLine == true && (gp.keyH.enterPressed == true || gp.keyH.tradeKeyPressed == true)) {
	...
	public void drawSleepScreen() {
		...
		if(counter < 120) {
			gp.eManage.lighting.filterAlpha += 0.01f;
			if(gp.eManage.lighting.filterAlpha > 1f) {
				gp.eManage.lighting.filterAlpha = 1f;
			}
		}
		if(counter >= 120) {
			gp.eManage.lighting.filterAlpha -= 0.01f;
			if(gp.eManage.lighting.filterAlpha <= 0f) {
				gp.eManage.lighting.filterAlpha = 0f;
				counter = 0;

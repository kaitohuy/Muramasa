	...
	public void setObject() {
		...
		switch (mapNum) {
			case 1: {
				...
				setUpObject(OBJ_Stone.class, 34, 4);
			...
			case 2: {
				...
				setUpObject(OBJ_Tree_Snow_1.class, 22, 0);
				setUpObject(OBJ_Tree_Snow_1.class, 26, 0);
				...
				setUpObject(OBJ_Tree_Snow_2.class, 24, 0);
				...
				setUpObject(OBJ_Stone_Snow.class, 25, 7);
				...
				setUpObject(OBJ_SnowMan.class, 46, 20);
	...
	public void setMonster() {
		...
		switch (mapNum){
			...
			case 3: {
				...
				setUpMonster(MON_Demon_Fire.class, 47, 39);
